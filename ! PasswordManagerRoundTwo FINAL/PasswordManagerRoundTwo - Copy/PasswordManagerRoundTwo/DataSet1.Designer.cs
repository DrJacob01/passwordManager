...
namespace PasswordManagerRoundTwo {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string ApplicationName, string Username, string Password) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string ApplicationName {
                get {
                    try {
                        return ((string)(this[this.tableTable.ApplicationNameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'ApplicationName\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.ApplicationNameColumn] = value;
                }
            }
            ...
            public bool IsApplicationNameNull() {
                return this.IsNull(this.tableTable.ApplicationNameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetApplicationNameNull() {
                this[this.tableTable.ApplicationNameColumn] = global::System.Convert.DBNull;
            }
...
namespace PasswordManagerRoundTwo.DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([ApplicationName], [Username], [Password]) VALUES (@Ap" +
                "plicationName, @Username, @Password);\r\nSELECT Id, ApplicationName, Username, Pas" +
                "sword FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [ApplicationName] = @ApplicationName, [Username] = @Username, [Password] = @Password WHERE (([Id] = @Original_Id) AND ((@IsNull_ApplicationName = 1 AND [ApplicationName] IS NULL) OR ([ApplicationName] = @Original_ApplicationName)) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT Id, ApplicationName, Username, Password FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PasswordManagerRoundTwo.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, ApplicationName, Username, Password FROM dbo.[Table]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[Table] ([ApplicationName], [Username], [Password]) VALUES (@Ap" +
                "plicationName, @Username, @Password);\r\nSELECT Id, ApplicationName, Username, Pas" +
                "sword FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ApplicationName", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "ApplicationName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].CommandText = "DELETE FROM [dbo].[Table]\r\nWHERE Id = @Id";
            ...
            this._commandCollection[3].CommandText = "SELECT Id, ApplicationName, Username, Password \r\nFROM dbo.[Table]\r\nWHERE    Appli" +
                "cationName LIKE @applicationName\r\nGROUP BY ApplicationName, Username, Password, " +
                "Id";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@applicationName", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "ApplicationName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "UPDATE [dbo].[Table]\r\nSET ApplicationName = @ApplicationName, Username = @Usernam" +
                "e, Password = @Password\r\nWHERE Id = @id";
            this._commandCollection[4].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ApplicationName", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "ApplicationName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int FindData(DataSet1.TableDataTable dataTable, string applicationName) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((applicationName == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(applicationName));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        public virtual int Delete(int Original_Id, string Original_ApplicationName, string Original_Username, string Original_Password) {
        ...
        public virtual int Insert(string ApplicationName, string Username, string Password) {
            if ((ApplicationName == null)) {
        ...
        public virtual int Update(string ApplicationName, string Username, string Password, int Original_Id, string Original_ApplicationName, string Original_Username, string Original_Password, int Id) {
            if ((ApplicationName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ApplicationName, string Username, string Password, int Original_Id, string Original_ApplicationName, string Original_Username, string Original_Password) {
            return this.Update(ApplicationName, Username, Password, Original_Id, Original_ApplicationName, Original_Username, Original_Password, Original_Id);
        }
        ...
        public virtual int AddData(string ApplicationName, string Username, string Password) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((ApplicationName == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
                command.Parameters[0].Value = ((string)(ApplicationName));
            }
            if ((Username == null)) {
        ...
        public virtual int UpdateData(string ApplicationName, string Username, string Password, int id) {
